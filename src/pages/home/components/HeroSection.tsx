          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            <div className="space-y-4 lg:space-y-6">
              <div className="inline-flex items-center px-3 py-2 sm:px-4 bg-primary/10 rounded-full text-primary font-medium text-xs sm:text-sm">
                ...
                First mover RegTech platform for Market Expansion and German SME's
              </div>
            ...
            <div className="mt-6 lg:mt-8 p-4 lg:p-6 bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl border border-primary/20">
              <div className="flex flex-col items-center lg:items-start">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-6 flex-wrap">
                  ...
                  />
                  <img 
                    src="https://static.readdy.ai/image/3d57a04e89a19f07dff1eb2283051a78/b52c88738ecdc6ba9e2ada0ec6a2e2c1.png" 
                    alt="UnternehmerTUM Logo" 
                    className="h-12 lg:h-16 object-contain"
                  />
                  <img 
                    src="https://static.readdy.ai/image/3d57a04e89a19f07dff1eb2283051a78/57b4c3017e37c4d59b90f50542c4406f.png" 
                    alt="IPI Logo" 
                    className="h-12 lg:h-16 object-contain"
                  />
                  <img 
                    src="https://static.readdy.ai/image/3d57a04e89a19f07dff1eb2283051a78/cdb1c62b037b22d0009fa506d8913f35.jpeg" 
                    alt="DSGVO Logo" 
                    className="h-12 lg:h-16 object-contain"
                  />
                </div>
            ...
            <div className="relative z-10 bg-white/95 backdrop-blur-lg rounded-3xl p-6 lg:p-10 shadow-2xl border border-accent/30 transform hover:scale-105 transition-all duration-500">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 lg:py-4 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300 rounded-lg font-semibold whitespace-nowrap cursor-pointer text-base lg:text-lg shadow-lg hover:shadow-xl"
                >
